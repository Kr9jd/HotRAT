...
public class FileManage extends Thread{
    ...
    InputStream inputStreams = FileManage.class.getClassLoader().getResourceAsStream("me/resources/files.png");
    InputStream inputStream1 = FileManage.class.getClassLoader().getResourceAsStream("me/resources/directory.png");
    InputStream inputStream2 = FileManage.class.getClassLoader().getResourceAsStream("me/resources/disks.png");
    ...
    public FileManage(Socket socket,String IP) throws Exception{
        System.setProperty("sun.java2d.noddraw", "true");
        Image image = ImageIO.read(inputStream);
        this.socket = socket;
        JDialog dialog = new JDialog();
        WindowUtils.setWindowAlpha(dialog,0.8f);
        ...
        button1.addActionListener(a->{
                ...
                flash(table,str,textField.getText());
        });
    ...
    public void flash(JTable table,String context,String path) {
        for(int index = table.getModel().getRowCount() - 1; index >= 0; index--) {
            defaultTableModel.removeRow(index);
        }
        SendMessage.Send(MessageFlags.FILE_QUERY, path.getBytes(), socket);
