...
public class Run {
    public static InputStream data = Run.class.getResourceAsStream("resources/Data.cfg");
    public static InputStream jar = Run.class.getResourceAsStream("resources/me.wtf");
